 ...
 *
 * A radial mask fades the image's own hard edges to transparent so it
 * blends into the page background instead of showing a visible box outline.
 */
function MapBackground({ position = 'top-right', opacity = 20, className = '' }) {
  ...
  const maskGradient = 'radial-gradient(ellipse at center, black 35%, transparent 72%)'
